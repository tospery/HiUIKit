...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HiDomain/HiDomain.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HiJSBridge/HiJSBridge.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HiTheme/HiTheme.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HiUIKit/HiUIKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/URLNavigator-Hi/URLNavigator_Hi.framework"
